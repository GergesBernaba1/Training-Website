...
<section class="about">
	<div class="container">
		<div class="row">
			...
			<h1 class="text-center">عن الأكاديمية</h1><hr>
			<p class="lead">مؤسسة ابداع للتدريب والاستشارات
			احدى المؤسسات المعنية بتنمية وتطوير القدرات البشرية اللامحدودة الموجودة داخل كل انسان لمواجهة العقبات والتحديات الفكرية التي تواجهه في المجتمع، والتي فرضتها ثورة المعرفة، ولمجاراة التطور والتقدم العلمي. 
			حيث أننا متخصصون فى تقديم برامج تدريبية بطريقة ابداعية فى جميع المجالات الحيايتة، يقدمها مدربون متخصصون من خلال أحدث وسائل التدريب الحديثة، وذلك مساهمة منّا فى تطوير أداء المؤسسات والأفراد.</p>
