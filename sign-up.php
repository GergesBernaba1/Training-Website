...
<section class="certify" style="direction: rtl; font-family: 'Changa', sans-serif;">
	<div class="container">
		<div class="row">

			<h1 class="text-center" style="font-family: 'Changa', sans-serif;">التسجيل في دورة تدريبية جديدة</h1><hr>
			
			<form class="form-horizontal" method="POST" action="thank.php">
				...
				<div class="form-group">
					<div class="col-sm-10">
						<input type="email" name="email" class="form-control" autocomplete="off" placeholder="الايميل">
					</div>
				...
				<div class="form-group">
					<div class="col-sm-10">
						<input type="text" name="phone" class="form-control" autocomplete="off" placeholder="رقم الهاتف">
					</div>
				...
				<div class="form-group">
					<div class="col-sm-10">
						...
						$rows = $stmt -> fetchAll();
						foreach ($rows as $row) { ?>
						<div class="col-xs-6"><p><input type="checkbox" value="<?php echo $row['course_name']?>" name="course[]" style="float: right;margin-right: 10px; margin-left: 30px;"><?php echo $row['course_name'];?><br></p></div>	
					<?php	}
						?>
					</div>
				...
				<div class="form-group">
					<div class="col-sm-10">
						<input type="submit" value="التسجيل الآن" class="btn btn-success btn-block" name="done">
					</div>
				</div>
