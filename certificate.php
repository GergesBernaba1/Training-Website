...
<section class="certify">
	<div class="container">
		<div class="row">
			<h1 class="text-center">التحقق من شهادات الدارسين</h1><hr>
			<p class="lead" style="font-family: cursive; font-weight:bold;">قم بكتابة اسمك رباعي</p>

			<div class="col-xs-12" id="ref"> 
				<h3>Ref . No رقم الشهادة</h3>
				<form method="post" action="search.php">
					
					<div class="form-group col-xs-12 col-md-10">
						<input type="text" name="name" class="form-control" autocomplete="off" placeholder="الاسم">
					</div>

					<div class="form-group col-md-2 col-xs-12">
						<input type="submit" name="search" value="search Now" class="btn btn-danger btn-block">
					</div>
				</form>
			</div>
