...
<?php $name = $_GET['course']; ?>

<section class="certify" style="direction: rtl; font-family: 'Changa', sans-serif;">
	<div class="container">
		<div class="row">

			<h1>أنت حاليا تقوم بالتسجيل في كورس : <p style="color:#000249; margin:30px 0;" class="text-center"><?php echo $name; ?></p></h1>

			<form class="form-horizontal" method="POST" action="../thank.php?course=<?php echo $name ; ?>">
